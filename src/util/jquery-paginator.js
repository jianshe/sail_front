...
(function($) {
  ...
  Paging.prototype = {
    ...
    bindEvent: function() {
      ...
      /*
			$(window).on('hashchange',function(){
				var page=  parseInt(GoPage.getHash('page'));
    ...
    bindToolbar: function() {
      ...
      //   );
      var html = $(
        '<li class="ui-paging-toolbar">跳到第<input type="text" class="ui-paging-count"/>页<button type="button" class="btn btn-primary btn-sm go">GO</button></li>'
      );
